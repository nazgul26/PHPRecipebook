...
?>
<h2><?php echo __('Welcome to PHPRecipeBook ') . Configure::read('App.version'); ?></h2>
<p>
    <?php echo __('This is the setup page for the application.  The following messages will indicate if your server has been properly setup.');?>
</p>
<?php
...
<p>
    <?php echo __('After correcting any issues above you can continue the setup process.');?>
</p>
