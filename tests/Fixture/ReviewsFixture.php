...
class ReviewsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'comments' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'recipe_id' => ['type' => 'unique', 'columns' => ['recipe_id', 'user_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'MyISAM',
