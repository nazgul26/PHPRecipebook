...
<?php echo $this->Form->create(null, ['id'=> 'ShoppingListForm', 'url' => array('controller' => 'ShoppingLists','action' => 'clear')]);?>
<?php echo $this->Form->control('vendor_id',array('label'=>'Select Vendor')); ?>
<?php echo $this->Form->control('formkey',array('label'=>'Form Key')); ?>
<?php echo $this->Form->control('timeOut',array('label'=>'Time Out', 'default' => '5000')); ?>
<table>
    <tr class="headerRow">
        <th></th>
