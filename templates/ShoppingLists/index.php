    ...
    <table>
        ...
        <tr>
            <td class="shoppingListText actions">
                ...
                <?php echo $this->Form->hidden('shopping_list_recipes.' . $mapIndex . '.id'); ?>
                <?php echo $this->Form->hidden('shopping_list_recipes.' . $mapIndex . '.recipe_id'); ?>
                <?php echo $this->Form->hidden('shopping_list_recipes.' . $mapIndex . '.shopping_list_id'); ?>
            </td>
            ...
            <td><?php echo $this->Form->control('shopping_list_recipes.' . $mapIndex . '.servings', array('label' => false)); ?></td>
        </tr>
        <?php } ?>
        </tbody>
    </table>
